          ...
          <div className="flex-1 max-w-[790px]">
            <div className="pt-6 mb-6">
              ...
              <div className="relative w-full h-[210px] lg:h-[462px] bg-gray-100 overflow-hidden rounded-xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 h-[36%] lg:h-[30%]  bg-black/30 backdrop-blur-[21px]" />

                <div className="absolute bottom-0 left-0 right-0 p-2 md:p-6 lg:p-6  md:ml-[16px]">
                  <h2
                    className="text-white text-[9px] md:text-[18px] lg:text-[24px]  font-bold mb-1 md:mb-2 leading-tight "
                    style={{ fontFamily: "unbounded" }}
                  >
                    {blog.title}
                  </h2>
                  <p
                    className="text-white/60 text-[9px] md:text-[13px] lg:text-[14px]"
                    style={{ fontFamily: "poppins" }}
                  >
